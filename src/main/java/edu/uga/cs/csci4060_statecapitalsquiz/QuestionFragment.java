...
public class QuestionFragment extends Fragment {
    ...
    public static QuestionFragment newInstance(String state, String city1, String city2, String city3, String key) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        if(orientation== Configuration.ORIENTATION_PORTRAIT) {
            ...
            v = inflater.inflate(R.layout.fragment_horizontal_question, container, false);
        }

        TextView questText = (TextView) v.findViewById(R.id.questionText);
        RadioButton answer1 = (RadioButton) v.findViewById(R.id.radioButton3);
        RadioButton answer2 = (RadioButton) v.findViewById(R.id.radioButton);
        RadioButton answer3 = (RadioButton) v.findViewById(R.id.radioButton2);
        final Button next = (Button) v.findViewById(R.id.next);
        final Button prev = (Button) v.findViewById(R.id.prev);
        final RadioGroup radGroup = (RadioGroup) v.findViewById(R.id.qRadGroup);
        LinearLayout layout = (LinearLayout) v.findViewById(R.id.linLayout);

        questText.setText("What is the capital of "+mState+"?");
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(pickedID != -1) {
                    if (QuizActivity.pos == 1)
                        QuizActivity.q2Selected = rB.getText().toString();
                    if (QuizActivity.pos == 2)
                        QuizActivity.q3Selected = rB.getText().toString();
                    if (QuizActivity.pos == 3)
                        QuizActivity.q4Selected = rB.getText().toString();
                    if (QuizActivity.pos == 4)
                        QuizActivity.q5Selected = rB.getText().toString();
